  ...
  return (
    <section className="py-24 px-6 lg:px-24 bg-bg relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center glass-card border border-white/10 p-12 md:p-16 relative z-10 hover:shadow-[0_0_40px_rgba(0,240,255,0.15)] transition-shadow duration-500">
        ...
        <p className="mt-6 text-text-500 text-lg max-w-2xl mx-auto">
          Gather your elite team, find the hidden cryptographic code, and take
          on real-world security challenges.
        </p>
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-6">
          <a
            href="#register"
            className="px-8 py-4 rounded-xl bg-gradient-to-r from-primary to-neon-purple text-bg font-bold text-lg hover:shadow-[0_0_30px_rgba(0,240,255,0.4)] hover:scale-105 transition-all duration-300"
          >
            Register Team
          </a>
          <a
            href="#login"
            className="px-8 py-4 rounded-xl glass text-white font-semibold text-lg border border-white/20 hover:bg-white/10 transition-all duration-300"
          >
            Login Dashboard
          </a>
        </div>
