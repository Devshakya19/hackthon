      ...
      >
        ...
        <div className="glass-card border border-white/10 p-8 md:p-10 shadow-2xl relative overflow-hidden group">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-text-500 text-sm mt-2">Sign in to your security console</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="block text-xs uppercase tracking-widest text-text-500 font-semibold">Password</label>
