...
export default function SeatManager() {
  ...
  async function assignSeat(
    ...
    const { error } = await updateTeam(teamId, {
      room_id: roomId || null,
          ...
          >
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-[1fr_1fr_auto]">
              <select
                value={team.room_id ?? ""}
                onChange={(e) =>
                  assignSeat(team.id, e.target.value, team.seat_number ?? "")
                }
